# PIC N LUC
## Description
This is a short game created for the TI-84 calculator, written in TI-Basic, and currently in development. It is designed to work on a standard TI-84 Plus model and TI-84 Plus CE.
## Features
- The game has story-based gameplay where the players make different decisions that shape the narrative and affect the outcome of the game, which leads to multiple paths and different endings.
...
- I also hope to find ways to test other TI-Basic capabilities.
- Once you get to the end of the paths (with what they have right now), the code goes back into each other, which is very confusing, and I will fix that by keeping them all separate.  
## Installation
